### Performance Metrics for Document Ranking
### Adapted from: https://github.com/castorini/duobert/blob/master/metrics.py

### Document Reference for Definitions : https://en.wikipedia.org/wiki/Evaluation_measures_(information_retrieval)#Mean_average_precision
import numpy as np
